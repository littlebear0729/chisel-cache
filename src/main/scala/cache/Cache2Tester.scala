...
class Cache2Tester(dut: Cache2) extends PeekPokeTester(dut) {
...
object Cache2Tester extends App {
  chisel3.iotesters.Driver(() => new Cache2(), "treadle") { dut =>
    new Cache2Tester(dut)
  }
}
